...
**🏢 사내 교육 (확정: 2026-06-08 ~ 06-10, 3일 집중)**: 9개 세션을 3일에 압축한 *프리뷰* 성격. 매일 3 세션씩.
- **Day 1 (6/8 월)**: 세션 1-3 (Agentic AI · Multi-Agent · 제품 문서 RAG)
- **Day 2 (6/9 화)**: 세션 4-6 (Advanced RAG · Domain SLM · Multi-Modal SLM)
- **Day 3 (6/10 수)**: 세션 7-9 (PEFT · 양자화 · Vision)

교육 후 W4 후반에 *교육 노트 정리 + 깊이 가져갈 주제 우선순위 재확정* 30분. 본 커리큘럼은 *프리뷰 후 깊이 확보* 의 구조.
